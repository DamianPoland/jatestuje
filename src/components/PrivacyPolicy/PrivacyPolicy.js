    ...
    return (
        <main className={style.background}>
            <section className={style.privacyContainer}>
                ...
                <h1>Polityka prywatności serwisu jaTestuje.pl</h1>
                <hr />
                ...
                <div>
                    ...
                    <ol>
                        ...
                        <li>Operatorem serwisu oraz Administratorem danych osobowych jest: JaTestuje</li>
                    ...
                    <h2><strong className={style.font}>2. Dane osobowe</strong></h2>
                    <ol>
                    ...
                    <h2><strong className={style.font}>10. Kontakt</strong></h2>
                    <ol>
                        <li>Wszystkie dostępne formy kontaktu znajdują się w zakładce "kontakt" Serwisu jaTestuje.pl".</li>
